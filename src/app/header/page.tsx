  ...
  return (
    <nav className="bg-gradient-to-r from-pink-500 to-violet-500 w-full flex flex-row justify-between items-center h-24 px-8 absolute top-0">
      ...
      <div>
        ...
        <Link href="/" locale="en">
          <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">{t('english')}</h2>
        </Link>
        <Link href="/" locale="fr">
          <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">{t('french')}</h2>
        </Link>
      </div>
